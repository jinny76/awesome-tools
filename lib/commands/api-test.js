...
// 数据目录
const DATA_DIR = path.join(__dirname, '../../mcp-test/test-data');
...
async function startMCPServer() {
  ...
  console.log(`      "args": ["${path.resolve(__dirname, '../../mcp-test/server.js')}"]`);
  console.log('    }');
  console.log('  }');
  console.log('}');
  console.log('```');
  console.log('');
  console.log('或使用命令:');
  console.log(`claude mcp add api-test -- node "${path.resolve(__dirname, '../../mcp-test/server.js')}"`);
  console.log('');
